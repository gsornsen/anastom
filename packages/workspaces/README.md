...
Single-worker task execution and durable recovery are delivered. Parallel worktrees, shared integration, approvals, and additional runtime integrations remain roadmap work; see [milestones](../../docs/MILESTONES.md).
