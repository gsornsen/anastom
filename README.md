...
| **M3 — Durable execution**       | Feasibility | The supervisor passes on Linux/macOS and SQLite contention passes locally; workspace, snapshot, and API work remain.                                   |
