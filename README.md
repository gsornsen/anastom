...
| **M3 — Durable execution**       | Feasibility | Supervisor and SQLite evidence pass cross-platform; exact workspace evidence passes locally; cross-platform workspace, snapshot, and API work remain.  |
