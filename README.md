...
| **M3 — Durable execution**       | Contract | Model-free feasibility passes on Linux/macOS; exact production schemas and APIs remain under separate review.                                          |
