...
| **M3 — Durable execution**       | Building | Feasibility passes on Linux/macOS; runtime reconstruction, recovery events, private paths, workspace checkpoints, the fenced store, shared execution ownership, and engine recovery coordination are implemented while CLI composition and acceptance remain. |
