...
| **M3 — Durable execution**       | Feasibility | Supervisor and SQLite contention evidence pass on Linux/macOS; workspace, snapshot, and API work remain.                                               |
