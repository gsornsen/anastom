...
| **M3 — Durable execution**       | Building | Feasibility passes on Linux/macOS; the production stack through CLI composition and operator commands is implemented while process-level crash/recovery acceptance remains. |
