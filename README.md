...
| **M3 — Durable execution**       | Building | Feasibility passes on Linux/macOS; runtime reconstruction, recovery events, private state paths, and workspace checkpoints are implemented while durable storage, execution ownership, recovery, and CLI layers remain. |
