...
| **M3 — Durable execution**       | Feasibility | Supervisor, SQLite, and exact-workspace evidence pass on Linux/macOS; snapshot and production API work remain.                                         |
