...
| **M3 — Durable execution**       | Building | Feasibility passes on Linux/macOS; runtime reconstruction and recovery event contracts are implemented while storage, execution ownership, recovery, and CLI layers remain. |
