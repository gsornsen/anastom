...
| **M3 — Durable execution**       | Feasibility | The shared supervisor protocol passes on Linux/macOS; fenced state, workspace checkpoints, and snapshot evidence remain.                               |
