...
| **M3 — Durable execution**       | Contract | Model-free feasibility passes on Linux/macOS; the exact production contract is proposed for review before implementation.                              |
